    ...
    "params": [
        {
            ...
            "oauthRefreshURL": "https://www.googleapis.com/oauth2/v4/token",
            "required": True
        },
        {
            "name": "refresh_token",
        ...
        },
        {
            ...
            "required": True,
            "type": "list",
            "values": lambda s: Stream(s, {}).get_files(),
